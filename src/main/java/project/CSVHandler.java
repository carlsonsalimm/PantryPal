...
public class CSVHandler {
    ...
    public static boolean writeRecipes(String username, String password, Recipe recipe) throws IOException {
        MongoDBProject.updateRecipe(username, password, recipe.getTitle(), recipe.getInstructions(), "mealType", "ingredients", 0, password);
        return true; // 
    }

    public static void updateRecipe(String username, String password, Recipe oldRecipe, Recipe newRecipe) throws IOException {
        MongoDBProject.updateRecipe(username, password, oldRecipe.getTitle(), newRecipe.getInstructions(), "updatedMealType", "updatedIngredients", 0, password);
    }
