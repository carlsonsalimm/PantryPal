...
public class SpecifyIngredientPageController {
    private SpecifyIngredientPage view;
    private Model model;

    public SpecifyIngredientPageController(SpecifyIngredientPage view, Model model) {
        this.view = view;
        this.model = model;
